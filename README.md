...
SPIDER welcomes contributions that preserve its authorized-use safety model.
Before contributing, read the community and security files:

| File | Purpose |
| ---- | ------- |
| [`CONTRIBUTING.md`](CONTRIBUTING.md) | Development setup, testing expectations, safety rules, and PR checklist |
| [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) | Community behavior expectations and reporting process |
| [`SECURITY.md`](SECURITY.md) | Private vulnerability reporting policy and response expectations |
| [`ETHICAL_USE.md`](ETHICAL_USE.md) | Authorized-use boundaries for this dual-use security tool |
| [`docs/open-source-release.md`](docs/open-source-release.md) | Maintainer checklist for public-release readiness |

Do not open public issues or pull requests containing secrets, PII, real target
data, private engagement artifacts, or vulnerability details that should be
reported privately.
