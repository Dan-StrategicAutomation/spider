...
class SessionDB:
    ...
    def _get_conn(self):
        # ⚡ Bolt Optimization: Use persistent SQLite connection.
        # Expected performance impact: Reuses the connection, drastically reducing I/O overhead
        # and preventing file descriptor leaks caused by repeatedly opening/closing DB connections.
        import sqlite3
