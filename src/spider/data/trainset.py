...
import dspy
from spider.schemas import ReconResults, PortInfo, ServiceInfo, VulnerabilityList, VulnerabilityInfo
...
PLANNING_TRAINSET = [
    dspy.Example(
        ...
        attack_plan="Attempt path traversal on Apache 2.4.49 using CVE-2021-41773. Target /cgi-bin/.%%32%65/."
