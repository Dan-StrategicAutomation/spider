...
def test_recon_catalog_exposes_tcp_scan_for_service_enum():
    """RECON catalog should let service enumeration use local TCP scanning."""
    catalog = build_tool_catalog({"tcp_port_scan"}, ScanMode.RECON)
